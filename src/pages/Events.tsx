...
const events = [
  ...
  },
  {
    ...
    description: "The biggest street party in Nasarawa State! Live performances, food vendors, and non-stop music. Bring the whole family!",
    artists: ["DJ Play X", "Rohi", "Killerverse", "Capt Karisma"],
  ...
  },
  {
    ...
    location: "Chiller's Arena",
    description: "Ring in the new year with the biggest celebration in Keffi. Live performances, fireworks, and premium drinks all night.",
    artists: ["DJ Play X", "Jaku Beatz", "Special Guests"],
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main>
        <PageHeader
          title="Events"
          subtitle="Don't miss the hottest events in Keffi. RSVP and secure your spot."
        />
